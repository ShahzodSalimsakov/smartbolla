  ...
  return (
    ...
    >
      ...
      <p>
        ...
        conditions of your use of the smartbolla.com website ("Website" or
        ...
        "our"). By accessing and using the Website and Services, you acknowledge
        ...
        Website and Services. You acknowledge that this Agreement is a contract
        between you and the Operator, even though it is electronic and is not
        physically signed by you, and it governs your use of the Website and
        Services. This terms and conditions policy was created with the help of
      ...
      <p>
        ...
        connection with it. We may monitor and review new accounts before you
        ...
        of such acts or omissions. We may suspend, disable, or delete your
        account (or any part thereof) if we determine that you have violated any
        provision of this Agreement or that your conduct or content would tend
      ...
      <p>
        ...
        procedural laws of United Arab Emirates without regard to its rules on
        conflicts or choice of law and, to the extent applicable, the laws of
        United Arab Emirates. The exclusive jurisdiction and venue for actions
        related to the subject matter hereof shall be the courts located in
        United Arab Emirates, and you hereby submit to the personal jurisdiction
